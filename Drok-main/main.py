...
def generate_blog_outline(
    ...
    prompt = """Objective: Create a comprehensive and detailed outline for a blog post based on the primary keyword, intent, and associated keywords. This outline should serve as a robust framework for writing an in-depth and informative article.
...
def generate():
    ...
    clusters = [ {
            ...
            'keywords': [
    "15.6\" FHD portable monitor",
    "Portable monitor for travelers",
    "Best portable monitor for travel",
    "Travel monitor",
    "ReHisk portable monitor",
    "FHD portable monitor",
    "Laptop monitor for travel",
    "Portable screen for laptop",
    "Dual screen for travel",
    "Lightweight portable monitor",
    "Business travel monitor",
    "Monitor for digital nomads",
    "Travel accessories for remote work",
